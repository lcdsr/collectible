...
class CommandStringHelpFormatter extends CommandHelpFormatter {
    ...
    formatUsage() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const formattedInputs = metadata.inputs ? yield Promise.all(metadata.inputs.map((input) => tslib_1.__awaiter(this, void 0, void 0, function* () { return this.formatInlineInput(input); }))) : [];
            return (`\n  ${strong('Usage')}:` +
    ...
    formatInputs() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const fillStrings = format_1.generateFillSpaceStringList(inputs.map(input => input.name), this.dotswidth, weak('.'));
